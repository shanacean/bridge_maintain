  ...
  <el-container class="home-container">
    ...
    <el-header height="45px">
      ...
      <el-dropdown>
        ...
        <template #dropdown>
          <el-dropdown-menu style="width: 100px; background-color: #272f40;">
            <el-dropdown-item icon="el-icon-remove">
              <span @click="logout" style=" color: #d6d7d8">退出</span>
            </el-dropdown-item>
          </el-dropdown-menu>
        </template>
      </el-dropdown>
    ...
    <el-container>
      ...
      <el-aside :width="isCollapse ? '56px' : '200px'">
        <div class="toggle-button" @click="toggleEvent">
          <i
            class="el-icon-s-unfold"
            style="font-size: 16px; color: #90939A"
          ></i>
        </div>
        <el-menu
        ...
        >
          ...
          <el-submenu
            :index="menu.path"
            v-for="menu in menuList.menus"
            :key="menu.mid"
          >
            <template #title>
              <i :class="menu.icon"></i>
              <span style="padding-left: 5px">{{ menu.title }}</span>
            </template>
            ...
            >
              ...
              <span style="padding-left: 5px">{{ submenu.title }}</span>
            </el-menu-item>
          </el-submenu>
        </el-menu>
      </el-aside>
...
export default {
  setup() {
    ...
    onMounted(() => {
      ...
      menuList.menus = computed(() => store.state.rightList)
